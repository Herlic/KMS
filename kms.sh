...
echo "# Description: deploy the vlmcsd server(KMS激活服务端)"
echo "# Version: 1.0.0"
echo "# Author:Herlic"
echo "# Date:31/07/2019"
echo "# Blog:https://www.herlic.com"
echo "# kms_server:kms.herlic.com"
echo "#============================================================================="
...
echo -e "  vlmcsd服务端 一键管理脚本 ${Red_font_prefix}Powered By Herlic${Font_color_suffix}
