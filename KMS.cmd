chcp 936
@echo off&PUSHD  &TITLE Herlic_KMS激活
...
:start
set KMS_Sev=kms.herlic.com
cls
echo VL版本系列windows和office激活脚本;
echo 首先感谢vlmcsd的作者,其GitHub项目地址:https://github.com/Wind4/vlmcsd
echo Herlic                                                  
echo =======================================================
echo  HH     HH HHHHHHHH HHHHHHH  HH       HHHH  HHHHHH        
echo  HH     HH HH       HH    HH HH        HH  HH    HH 
echo  HH     HH HH       HH    HH HH        HH  HH
echo  HHHHHHHHH HHHHHH   HHHHHHH  HH        HH  HH
echo  HH     HH HH       HH  HH   HH        HH  HH      
echo  HH     HH HH       HH   HH  HH        HH  HH    HH
echo  HH     HH HHHHHHHH HH    HH HHHHHHHH HHHH  HHHHHH                        
echo =======================================================                                                       

echo 我的个人网站:https://www.herlic.com/;
echo kms服务器地址:kms.herlic.com,方便喜欢手动激活的朋友;
echo 有问题请反馈在我的博客留言，或者发送至我的邮箱:herlic@herlic.com;
echo 正在检查与激活服务器的连接情况......请耐心等待;
echo.
ping kms.herlic.com | find "超时"  > NUL &&  goto fail
ping kms.herlic.com | find "目标主机"  > NUL &&  goto fail
echo 成功连接上服务器……
...
set Enterprise2015LTSB=WNMTR-4C88C-JK8YV-HQ7T2-76DF9
set Enterprise2015LTSBN=2F77B-TNFGY-69QQF-B8YKP-D69TJ
set EnterpriseLTSB2016=DCPHK-NFMTC-H88MJ-PFHPY-QJ4BJ
set EnterpriseNLTSB2016=QFFDN-GRT3P-VKWWX-X7T3R-8B639
set EnterpriseLTSC2019=M7XTQ-FN8P6-TTKYV-9D4CC-J462D
...
if defined %EditionID% (
	...
	cscript //Nologo %windir%\system32\slmgr.vbs /skms kms.herlic.com
...
if DEFINED _Office%1Path (
    ...
    cscript //nologo ospp.vbs /sethst:kms.herlic.com >nul
